...
deployment "dev" {
  inputs = {
    ...
    security_groups = {
      ...
      access_security_group_name = upstream_input.sec-grp-stacks-demo.dev.access_security_group_name
    }
  }
}
...
deployment "prod" {
  inputs = {
    ...
    demo           = "tf-stacks-demo-mike"
    security_groups = {
      front_door_security_group_name = upstream_input.sec-grp-stacks-demo.prod.front_door_security_group_name
      access_security_group_name     = upstream_input.sec-grp-stacks-demo.prod.access_security_group_name
    }
  }
}
